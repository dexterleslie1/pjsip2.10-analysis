...
void legacy_main(void)
{
    ...
    keystroke_help();
	//===============服务器===========端口===端口=====密码==========显示名==
	char *prm[] = { "122.10.161.183","5098","610000","Aa321321!@#","+8613512610000" };
	...
	ui_init_buddy("<sip:600002@122.10.161.183:5098>");
	ui_init_buddy("<sip:600003@122.10.161.183:5098>");
	ui_init_buddy("<sip:600004@122.10.161.183:5098>");
	ui_init_buddy("<sip:600005@122.10.161.183:5098>");
	ui_init_buddy("+324602020171<sip:600006@122.10.161.183:5098>");
	ui_init_buddy("+324602020171<sip:+324602020171@122.10.161.183:5098>");
	ui_init_buddy("<sip:600007@122.10.161.183:5098>");
	ui_init_buddy("<sip:600008@122.10.161.183:5098>");
//	printf("**********************************123456789*********************************************\n");//方便搜索
